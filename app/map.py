...
class Map:
	...
	def bounding_box(self):
		...
		#Чтобы это сделать надо пройтись по всем полигонам. У кадого полигона есть функция boundingRect().
		#Теперь надо объеденить все пямоугольники в один, в этом тебе поможет функция united() у QRectF 		
		pass
